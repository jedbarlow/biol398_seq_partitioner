...
\addcontentsline{toc}{subsection}{CSV output directory}
...
\addcontentsline{toc}{subsection}{CSV base file name}
...
\addcontentsline{toc}{subsection}{Java regular expression to match}
    %TODO

\item \textit{Java regular expression replacement} \hfill \\
\addcontentsline{toc}{subsection}{Java regular expression replacement}
    %TODO
